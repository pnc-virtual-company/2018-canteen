<?php 
/**
     * display lunch in admin dashbard 
...
<div class="container">
		...
		<div class="row">
			...
			<?php 
			foreach ($dishes as $breakfast) {  //start foreach to looop each dishes
			?> 
			<div class=" col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="thumbnail">
						<a href="<?php echo base_url();?>assets/images/dish_uploads/5.jpg" target="_blank">
