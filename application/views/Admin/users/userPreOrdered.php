 ...
 * @author  Copyright (c) 2014-2018 kimsoeng kao
 */
?>
<style>
    .dish-info{
...
<main class="app-content">
  <div class="app-title">
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo base_url();?>Admin/PreOrder/exportUserOrdered" class="btn btn-primary float-right"><i class="mdi mdi-file-excel"></i>&nbsp;Export</a>
